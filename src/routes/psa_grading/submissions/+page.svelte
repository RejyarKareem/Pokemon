...
<div class="grading-bg text-white d-flex align-items-center justify-content-center">
  <div class="container py-5" style="max-width: 800px;">
    ...
    <!-- Seitenüberschrift -->
    <h1 class="display-4 fw-bold text-center mb-5">Meine PSA-Grading-Anfragen</h1>

    {#if submissions.length === 0}
      <!-- Falls noch keine Grading-Anfragen eingereicht wurden -->
      <p class="lead text-center">Du hast noch keine Grading-Anfragen gesendet.</p>
    {:else}
          ...
          <div class="list-group-item bg-light text-dark rounded shadow-sm mb-3">
            <div class="d-flex justify-content-between align-items-start mb-2">
              ...
              <div>
                ...
                <small class="text-muted">Anzahl: {sub.quantity} – Zustand: {sub.serviceLevel}</small>
              </div>
            ...
            <p class="mb-1"><strong>Kontakt:</strong> {sub.name} &mdash; {sub.email}</p>
            {#if sub.notes}
